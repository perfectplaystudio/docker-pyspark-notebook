...
ENV SPARK_CLASSPATH /usr/local/spark/lib/mysql-connector-java.jar:/usr/local/spark/lib/spark-redshift.jar:/usr/local/spark/lib/spark-csv_2.11-1.3.0.jar:/usr/local/spark/lib/commons-csv-1.2.jar:/usr/local/spark/lib/RedshiftJDBC41-1.1.10.1010.jar:/usr/local/spark/lib/spark-streaming-kinesis-asl.jar:/usr/local/spark/lib/spark-avro.jar
