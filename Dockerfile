FROM dpatriot/docker-spark:1.3
...
ENV SPARK_CLASSPATH /usr/local/spark/jars/mysql-connector-java.jar:/usr/local/spark/jars/spark-redshift.jar:/usr/local/spark/jars/spark-csv_2.11-1.3.0.jar:/usr/local/spark/jars/commons-csv-1.2.jar:/usr/local/spark/jars/RedshiftJDBC41-1.1.10.1010.jar:/usr/local/spark/jars/spark-streaming-kinesis-asl.jar:/usr/local/spark/jars/spark-avro.jar
